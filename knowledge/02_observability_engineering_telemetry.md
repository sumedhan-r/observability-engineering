# Observability Engineering - Telemetry

## Table of Contents

- [Abbreviations](#abbreviations)
- [Overview](#overview)
- [Building Block of Observability](#building-block-of-observability)
  - [Structured Events](#structured-events)
  - [Limitations of Metrics](#limitations-of-metrics)
  - [Limitations of Logs](#limitations-of-logs)
- [Tracing](#tracing)
  - [Components of Traces](#components-of-traces)
- [Instrumentation - OpenTelemetry](#instrumentation---opentelemetry)
  - [Components of Opentelemetry](#components-of-opentelemetry)
  - [Auto Instrumentation](#auto-instrumentation)
  - [Main Design feature enabling Observability for any System](#main-design-feature-enabling-observability-for-any-system)
- [Events transformed for Observability](#events-transformed-for-observability)
  - [Traditional Approaches](#traditional-approaches)
  - [Observability-oriented Approaches](#observability-oriented-approaches)
    - [Core-Analysis Loop](#core-analysis-loop)
- [Observability and Monitoring cohesion](#observability-and-monitoring-cohesion)
  - [System vs Software](#system-vs-software)
  - [Hybrid Observability-Monitoring scopes among various Service providers](#hybrid-observability-monitoring-scopes-among-various-service-providers)
    - [Hardware/Infrastructure services](#hardwareinfrastructure-services)
    - [Platform services](#platform-services)
    - [Backend/API services](#backendapi-services)
    - [User facing applications](#user-facing-applications)
  - [Ideal Middle Ground](#ideal-middle-ground)
